package com.timson.react_native_wx_ali_pay.share;
...
public class WeChatModule extends ReactContextBaseJavaModule implements IWXAPIEventHandler {
    private static final String TAG = WeChatModule.class.getName();
    ...
    public void registerApp(String appid, Callback callback) {
        ...
        Log.e(TAG, "registerApp---->appid:"+appid+"--->"+result);
    }
    ...
    public void isWXAppInstalled(Callback callback) {
        ...
        callback.invoke(wxAvailable);
        Log.e(TAG, "wxAvailable---->:"+wxAvailable);
    }
    ...
    public void shareToTimeline(ReadableMap data, Callback callback) {
        ...
        String webpageUrl = data.getString("webpageUrl");
		String filePath = data.getString("filePath");
		String type = data.getString("type");
        Log.e(TAG, "shareToTimeline---->thumbImage:"+thumbImage+",webpageUrl:"+webpageUrl+",title:"+title+",webpageUrl="+webpageUrl+",filePath="+filePath+",description="+description+",type="+type);
    }
    ...
    private void _share(final int scene, final ReadableMap data, final Callback callback) {
        ...
        if (data.hasKey("thumbImage")) {
            String thumbImage = data.getString("thumbImage");
            try {
                uri = Uri.parse(thumbImage);
                if (uri.getScheme() == null) {
                    uri = getResourceDrawableUri(getReactApplicationContext(), thumbImage);
                }
            } catch (Exception e) {
                e.printStackTrace();
            }
    ...
    private void __jsonToImageFileMedia(ReadableMap data, MediaObjectCallback callback) {
        ...
        String imageUrl = data.getString("filePath");
    ...
    private WXMusicObject __jsonToMusicMedia(ReadableMap data) {
        ...
        ret.musicUrl = data.getString("filePath");
        return ret;
    }
    ...
    private WXVideoObject __jsonToVideoMedia(ReadableMap data) {
        ...
        ret.videoUrl = data.getString("filePath");
        return ret;
    }
